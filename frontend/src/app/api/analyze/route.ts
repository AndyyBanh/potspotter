...
const SYSTEM_PROMPT = `You are a pothole classification expert. Analyze the photo and determine if it contains a pothole and how severe it is.
...
0 = Not a pothole (image does not contain a pothole)
1 = Light / small holes
